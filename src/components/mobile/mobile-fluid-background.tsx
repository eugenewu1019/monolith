  ...
  if (prefersReducedMotion) {
    return (
      <div className="pointer-events-none absolute inset-0 z-0 opacity-80">
        <div className="absolute left-1/2 top-20 h-72 w-72 -translate-x-1/2 rounded-full bg-zodiac-gold/10 blur-3xl" />
        <div className="absolute bottom-16 right-0 h-56 w-56 rounded-full bg-zodiac-moss/15 blur-3xl" />
      </div>
    );
  }
      ...
      <Canvas
        ...
        onCreated={({ gl }) => {
          ...
          gl.domElement.setAttribute(
            "aria-label",
            "Subtle animated mineral sphere background for the mobile Monolith page.",
          );
        }}
      >
